...
// Created: 3/9/2012 8:24:07 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcs3q2ol0vz5bdznfnf3ifnxf_8i8d";
	this.domain="statse.webtrendslive.com";
	this.timezone=-8;
	this.fpcdom=".esri.com";
	this.onsitedoms="";
	this.downloadtypes="doc,docx,exe,flv,mp3,mp4,pdf,txt,wmv,xls,zip";
